...
/**
 * Plugin Name: LT Core
 * Description: Fork version of Unyson plugin. Required for the theme.
 * Version: 3.4.2
...
include 'lt-init.php';
include 'lt-sections.php';
include 'lt-custom.php';

//define( 'LT_ACTIVATION_URL', plugin_dir_url( __FILE__ ) . 'lt-activation/' );
include plugin_dir_path( __FILE__ ) . 'lt-activation/lt-activation-init.php';
