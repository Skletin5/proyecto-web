...
<div class="fw-ext-backups-demo-status-modal">
	...
	<?php elseif ($install_is_pending): ?>
		<p><img src="<?php echo get_site_url() ?>/wp-admin/images/loading.gif" alt="Loading"></p>
	...
	<img src="<?php echo get_site_url() ?>/wp-admin/images/loading.gif" alt="Loading" class="wp-spinner" />
</div>
