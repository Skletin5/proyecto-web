...
if ( function_exists( 'FW' ) ) {
	...
	$sana_current_scheme_db = fw_get_db_post_option( $wp_query->get_queried_object_id(), 'color-scheme' );
	
	add_filter ('sana_current_scheme', function() {
		global $sana_current_scheme_db;
		if ($sana_current_scheme_db == 'default') $sana_current_scheme_db = 1; 
		return $sana_current_scheme_db; 
	} );
...
if ( !sana_check_active_sidebar() OR sana_is_wc('cart') OR sana_is_wc('checkout') ) {
