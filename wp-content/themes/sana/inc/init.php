...
class sana_Theme_Includes {
	...
	public static function init() {
		 ...
		 */
		{
			...
			add_action( 'init', array( __CLASS__, 'sana_action_init' ) );
		}
		 ...
		 */
		if ( ! is_admin() ) {
			add_action('wp_enqueue_scripts', array( __CLASS__, 'sana_action_enqueue_scripts' ),
	...
	private static function get_includes_files_list($dir_rel_path){
		...
		$custom_list =  apply_filters ('sana_filter_init_includes_custom_files', array());
	 ...
	 * @internal
	 */
	public static function sana_action_enqueue_scripts() {
	 ...
	 * @internal
	 */
	public static function sana_action_init() {
