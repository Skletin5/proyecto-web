...
class sana_featured_content {
	...
	public static function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'featured-content[tag-name]', array(
			'default'              => _x( 'featured', 'featured content default tag slug', 'sana' ),
			'type'                 => 'option',
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'    => esc_html__( 'Tag Name', 'sana' ),
			'section'  => 'featured_content',
			'priority' => 20,
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => esc_html__( 'Don&rsquo;t display tag on front end.', 'sana' ),
			'section'  => 'featured_content',
			'type'     => 'checkbox',
			'priority' => 30,
		) );
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'sana' ),
		);
